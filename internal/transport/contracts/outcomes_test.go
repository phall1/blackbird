...
func fixtureContextCheckpointPage(t *testing.T) ContextPageDTO {
	...
	return ContextPageDTO{
		...
		Checkpoint: &ContextCheckpointDTO{
			...
			Workspace:    resource(domain.AggregateKindWorkspace, idWorkspace),
			...
			Device:       nil, Grants: []ContextResourceDTO{}, Collaborators: []ContextResourceDTO{},
			ThroughCursor:     "bbcc1_fixture",
